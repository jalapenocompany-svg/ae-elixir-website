...
const presets: Preset[] = [
  ...
  { name: "GHK-CU 50mg", vialMg: 50, bacMl: 3, doseMcg: 2000, color: "#2563EB" },
  { name: "MOTS-c 10mg", vialMg: 10, bacMl: 1, doseMcg: 1000, color: "#F97316" },
  { name: "Retatrutide 15mg", vialMg: 15, bacMl: 1.5, doseMcg: 1000, color: "#7C3AED" },
  { name: "NAD+ 500mg", vialMg: 500, bacMl: 3, doseMcg: 25000, color: "#EC4899" },
  { name: "BPC157 / TB500 20mg", vialMg: 20, bacMl: 2, doseMcg: 2000, color: "#16A34A" },
  { name: "Tesamorelin 10mg", vialMg: 10, bacMl: 2, doseMcg: 2000, color: "#EAB308" },
  { name: "CJC1295 / Ipamorelin 10mg", vialMg: 10, bacMl: 1, doseMcg: 1000, color: "#DC2626" },
  { name: "PT141 10mg", vialMg: 10, bacMl: 1, doseMcg: 1000, color: "#8B5CF6" },
  { name: "Semax 5mg", vialMg: 5, bacMl: 1, doseMcg: 1000, color: "#FB7185" },
{ name: "Selank 5mg", vialMg: 5, bacMl: 1, doseMcg: 1000, color: "#F472B6" },
{ name: "ARA 290 10mg", vialMg: 10, bacMl: 1, doseMcg: 1000, color: "#E11D48" },
...
function getPresetColor(name: string) {
...
export default function PeptideCalculatorPage() {
  ...
  const [liquidColor, setLiquidColor] = useState("#2563eb");
  ...
  function applyPreset(name: string) {
    ...
    setLiquidColor(getPresetColor(name));
  }

  function keepPresetColor() {
    setLiquidColor(getPresetColor(selectedPreset));
  }
                  ...
                  {[0.3, 0.5, 1].map((size) => (
                    <button
                      ...
                      className={`rounded-xl border px-4 py-2 text-sm font-semibold ${
                        syringeMl === size ? qpActive : qpInactive
                      }`}
                    >
                      {size}mL
                    </button>
                ...
                <div className="flex flex-wrap gap-2">
                  {vialQuickPicks.map((v) => (
                    <button
                      ...
                      onClick={() => pickVial(v)}
                      className={`rounded-xl border px-4 py-2 text-sm font-semibold ${
                        vialMg === v && customVial === "" ? qpActive : qpInactive
                      }`}
                    >
                      {v}mg
                    </button>
                ...
                <div className="flex flex-wrap gap-2">
                  {bacQuickPicks.map((v) => (
                    <button
                      ...
                      onClick={() => pickBac(v)}
                      className={`rounded-xl border px-4 py-2 text-sm font-semibold ${
                        bacMl === v && customBac === "" ? qpActive : qpInactive
                      }`}
                    >
                      {v}mL
                    </button>
                ...
                <div className="flex flex-wrap gap-2">
                  {doseQuickPicks[doseUnit].map((v) => (
                    <button
                      ...
                      onClick={() => pickDose(v)}
                      className={`rounded-xl border px-4 py-2 text-sm font-semibold ${
                        doseMcg === v && customDose === "" ? qpActive : qpInactive
                      }`}
                    >
                      {v}{doseUnit}
                    </button>
