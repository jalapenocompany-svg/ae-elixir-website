  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 text-black">
                      ...
                      {addressSuggestionsOpen && (
                        <div className="absolute left-0 right-0 top-full z-50 mt-2 max-h-64 overflow-y-auto rounded-2xl border border-[#E6E0D8] bg-white shadow-lg">
                          <button
                            ...
                            className="flex w-full items-center justify-between gap-3 border-b border-[#E6E0D8] bg-[#F8F5F1] px-4 py-3 text-left transition hover:bg-[#EFE8E1]"
                          >
                            <span>
                              <span className="block text-sm font-bold leading-5 text-[#A79B8E]">
                                Use the address I typed
                              </span>

                              <span className="mt-0.5 block text-xs font-semibold leading-5 text-[#7F756B]">
                                Close suggestions and continue manually
                              </span>
                            </span>

                            <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-[#D8D1C8] bg-white text-sm font-bold text-[#A79B8E]">
                              ×
                            </span>
                          </button>
      ...
      {showOrderReviewModal && (
        <div className="fixed inset-0 z-[90] flex items-center justify-center bg-black/50 px-4 py-5 backdrop-blur-[2px]">
          <div className="flex max-h-[90dvh] w-full max-w-md flex-col overflow-hidden rounded-[28px] border border-[#E6E0D8] bg-white shadow-2xl">
            <div className="shrink-0 border-b border-[#E6E0D8] px-5 py-4">
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="text-xs font-bold uppercase tracking-wide text-[#A79B8E]">
                    Review Order
                  ...
                  <h2 className="mt-1 text-2xl font-bold leading-tight text-[#5F554C]">
                ...
                <button
                  ...
                  className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-2xl leading-none text-[#7F756B] transition-all hover:bg-[#F6F3EF] active:scale-95"
                  aria-label="Close review order"
                >
                  ×
                </button>
              </div>
            ...
            <div className="min-h-0 flex-1 overflow-y-auto px-5 py-4">
              <div className="space-y-3">
                <div className="rounded-[24px] border border-[#D8D1C8] bg-[#FBFAF8] p-4 shadow-sm">
                  <p className="mb-2 text-xs font-bold uppercase tracking-wide text-[#A79B8E]">
                    Customer
                  </p>

                  <div className="space-y-1.5 text-[15px] leading-6 text-[#6F655C]">
                    <p>
                      <span className="font-bold text-[#5F554C]">Name:</span>{" "}
                      {form.fullName}
                    </p>

                    <p className="break-words">
                      <span className="font-bold text-[#5F554C]">Email:</span>{" "}
                      {form.email}
                    </p>

                    <p>
                      <span className="font-bold text-[#5F554C]">Phone:</span>{" "}
                      {form.phone}
                    </p>
                  </div>
                </div>
                ...
                <div className="rounded-[24px] border border-[#D8D1C8] bg-[#FBFAF8] p-4 shadow-sm">
                  <div className="mb-2 flex items-center justify-between gap-3">
                    ...
                    <p className="text-[11px] font-bold uppercase tracking-wide text-[#A35A2C]">
                      Verify
                    </p>
                  </div>

                  <div className="rounded-[20px] border border-[#E6E0D8] bg-white px-4 py-3 text-[15px] font-semibold leading-7 text-[#5F554C]">
                    {buildCustomerAddress()}
                  </div>

                  <p className="mt-2 text-xs font-semibold leading-5 text-[#A35A2C]">
                    Incorrect address? Tap “Back to Edit” before placing the order.
                  </p>
                </div>
                ...
                <div className="rounded-[24px] border border-[#D8D1C8] bg-[#FBFAF8] p-4 shadow-sm">
                  ...
                  <div className="divide-y divide-[#E6E0D8] overflow-hidden rounded-[20px] border border-[#E6E0D8] bg-white">
                    {cart.map((item) => (
                      <div
                        key={item.id}
                      ...
                      >
                        <div className="min-w-0">
                          <p className="font-bold leading-5 text-[#5F554C]">
                            {item.quantity}x {item.name}
                          </p>

                          <p className="mt-1 text-xs font-semibold text-[#8F8276]">
                ...
                <div className="rounded-[24px] border border-[#D8D1C8] bg-[#FBFAF8] p-4 shadow-sm">
                  ...
                  <div className="space-y-2 text-[15px] text-[#6F655C]">
                    <div className="flex items-start justify-between gap-3">
                      <span>Payment</span>
                      <span className="text-right font-bold text-[#5F554C]">
                        {selectedPaymentMethod?.display_label || form.paymentMethod}
                      </span>
                    </div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <span>Shipping</span>
                      <span className="text-right font-bold text-[#5F554C]">
                        {selectedShippingMethod?.display_label || "Not selected"}
                      </span>
                    </div>
            ...
            <div className="sticky bottom-0 shrink-0 border-t border-[#E6E0D8] bg-white p-4 shadow-[0_-8px_20px_rgba(0,0,0,0.04)]">
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  onClick={() => setShowOrderReviewModal(false)}
                  disabled={isSubmitting}
                  className="rounded-full border border-[#D8D1C8] bg-white px-3 py-3 text-sm font-bold text-[#A79B8E] shadow-sm transition-all hover:bg-[#F3F0EC] active:scale-95 disabled:opacity-50"
                >
                  Back to Edit
                </button>
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="rounded-full bg-[#A79B8E] px-3 py-3 text-sm font-bold text-white shadow-sm transition-all hover:bg-[#978D82] active:scale-95 disabled:opacity-50"
                >
